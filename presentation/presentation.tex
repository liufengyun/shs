...
%% \begin{frame}[fragile]
%%   \frametitle{Language is a Source of Human Creativity}

%%   Human beings can profit their linguistic capability to generate choices:
%%   \begin{itemize}
%%   \item{Negation}: Negate a sentence
%%   \item{Substitution}: Replace nouns with nouns, number with numbers, etc
%%   \end{itemize}
%% \end{frame}
